...
namespace E_Market_.Net_Core.Migrations
{
    ...
    [Migration("20230528074239_DB-SalesTableUpgrade")]
    partial class DBSalesTableUpgrade
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Market_.Net_Core.Models.DB_Classes.Sales", b =>
                {
                    ...
                    b.Property<int>("ProducsProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Market_.Net_Core.Models.DB_Classes.Sales", b =>
                {
                    b.HasOne("E_Market_.Net_Core.Models.DB_Classes.Current", "Current")
                        .WithMany("Sales")
                        .HasForeignKey("CurrentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("E_Market_.Net_Core.Models.DB_Classes.Employee", "Employee")
                        .WithMany("Sales")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("E_Market_.Net_Core.Models.DB_Classes.Product", "Producs")
                        .WithMany("Sales")
                        .HasForeignKey("ProducsProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
